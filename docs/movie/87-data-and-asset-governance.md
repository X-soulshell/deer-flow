...
这张图的重点不是给出精确数值，而是帮助团队先理解：不同治理对象的治理方式、频率和风险重点并不相同。
...
下面这张 ER 图 把“数据治理与资产治理”再压缩成一个可快速扫读的结构视图，便于先抓关键关系，再回到正文细节。
...
- 上一篇：[86. 团队组织与角色分工](./86-team-organization-and-role-allocation.md)
- 下一篇：[88. 安全、权限与审计](./88-security-permissions-and-audit.md)
