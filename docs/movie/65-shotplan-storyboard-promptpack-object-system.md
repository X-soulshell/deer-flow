...
下面这张 甘特图 把“ShotPlan / Storyboard / PromptPack 对象体系”再压缩成一个可快速扫读的结构视图，便于先抓关键关系，再回到正文细节。

```mermaid
gantt
    title ShotPlan / Storyboard / PromptPack 对象体系 的推进节奏
    dateFormat  YYYY-MM-DD
    axisFormat  %m-%d
    section 关键阶段
    对象定义 :a1, 2026-01-01, 5d
    状态变化 :after a1, 4d
    版本边界 :after a1, 5d
    审批治理 :after a1, 4d
    归档沉淀 :after a1, 3d
...
- 上一篇：[64. Budget / Schedule / Resource 对象体系](./64-budget-schedule-resource-object-system.md)
- 下一篇：[66. Review / Approval / ReleasePackage 对象体系](./66-review-approval-release-package-object-system.md)
...
- 65. ShotPlan / Storyboard / PromptPack 对象体系（当前）
