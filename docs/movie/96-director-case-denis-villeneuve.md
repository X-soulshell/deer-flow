...
```mermaid
flowchart TD
    A["Script"] --> B["DeerFlow 导演主智能体"]
    B --> C["分镜编排子智能体"]
    B --> D["风格一致性子智能体"]
    B --> E["声音与节奏预演子智能体"]
    B --> F["后期版本比较子智能体"]

    C --> G["Storyboard Graph"]
    D --> H["Color / Texture / Scale Constraints"]
    E --> I["Sound Pressure / Silence Design"]
    F --> J["Cut Comparison / Notes"]
...
如果把 Villeneuve 型项目的 AI 使用原则放进判断矩阵，会更容易看出为什么“低噪声、高约束”比“高产量候选”更重要：
...
下面这张 象限图 把“导演案例：Denis Villeneuve 在 AI 时代如何守住“存在感””再压缩成一个可快速扫读的结构视图，便于先抓关键关系，再回到正文细节。
