...
```mermaid
flowchart LR
    A["World Bible"] --> B["DeerFlow 导演主智能体"]
    B --> C["概念扩展子智能体"]
    B --> D["预演协调子智能体"]
    B --> E["资产连续性子智能体"]
    B --> F["交付治理子智能体"]
...
- 上一篇：[94. 导演案例：Christopher Nolan 在 AI 时代的工作法重构](./94-director-case-christopher-nolan.md)
- 下一篇：[96. 导演案例：Denis Villeneuve 在 AI 时代如何守住“存在感”](./96-director-case-denis-villeneuve.md)
...
- 95. 导演案例：James Cameron 在 AI 时代的系统工程电影观（当前）
