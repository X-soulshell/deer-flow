...
下面这张 ER 图 把“摄影、灯光、视效前期协同”再压缩成一个可快速扫读的结构视图，便于先抓关键关系，再回到正文细节。
...
- 所在分组：25-36 前期制作
- 上一篇：[31. 美术、服装、道具协同](./31-art-costume-props-collaboration.md)
- 下一篇：[33. 文字分镜与镜头表](./33-text-storyboard-and-shot-list.md)
